...
var bot_token = '5384036631:AAGWB2MkeD2hSqUE78-x_3tXsNywXwxp9zc'; //YOUR BOT TOKEN HERE

var bot_name = 'Njsservertesting'; // Bot Name
...
const admin_id2 = 2131044278;

var mongo_url = 'mongodb+srv://Robinop01:Robinop01@cluster0.rc2d1.mongodb.net/?retryWrites=true&w=majority'; // Your Mongo URL Here
...
bot.hears(/^\/start (.+[1-9]$)/, async (ctx) => {
    ...
    try {
        ...
        if (bots == 'Active') {
            ...
            bot.telegram.sendMessage(ctx.from.id,"*🚧 Please Share Your Account Contact By Clicking On '📞 Share Contact'*\n\n`🛡Your Privacy Is Secured With Us We Will Not Share Your Information`",{parse_mode:"markdown",reply_markup:{keyboard: [[{text:"📞 Share Contact",request_contact:true}]],resize_keyboard: true}})
        ...
        if (bots == 'Active') {
            ...
            if (flag == channel.length) {
                ...
                ctx.replyWithMarkdown(
                    ...
                    '*🏡 Welcome To Main Menu*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
        ...
        if (bots == 'Active') {
            ...
            if (flag == channel.length) {
                ...
                ctx.replyWithMarkdown(
                    ...
                    '*👋 Hello ' + ctx.from.first_name + '\n\n🔐 Your Balance: ' + ub.toFixed(3) + ' ' + currency + '\n\n👥 Share Your Refer Link To Earn More*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
    ...
    try {
        ...
        if (bots == 'Active') {
            ...
            if (flag == channel.length) {
                ...
                ctx.replyWithMarkdown(
  "*🏕 Welcome To Invite Section\n\n🫂 Your Invite Link: https://t.me/" + ctx.botInfo.username + "?start="+ ctx.from.id + " \n\n🚀 Invite Your Friends And Earn " + refer + " "+ currency + "*", { disable_web_page_preview: true, reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
            ...
            if (flag == channel.length) {
                ...
                if (('inviter' in userdata[0]) && !('referred' in config[0])) {
                  ...
                  if('verified' in config[0]){
                    ...
                    bot.telegram.sendMessage(userdata[0].inviter, "*⏳" + refer + " " + currency + " Added  For Refering:*", { parse_mode: 'markdown' })
...
bot.hears('📂 Wallet', async (ctx) => {
    ...
    try {
        ...
        if (bots == 'Active') {
            ...
            '*💬 Send Your Paytm Number To Set*', { parse_mode: 'markdown', reply_markup: { keyboard: [['⛔ Cancel']], resize_keyboard: true } }
                ...
                if (flag == channel.length) {
                    ...
                    if (ub < mini_with) {
                        ...
                        ctx.replyWithMarkdown(
                            ...
                            '*⚠️ Must Own AtLeast ' + mini_with + ' ' + currency + ' To Make Withdrawal*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
                        ...
                        ctx.replyWithMarkdown(
                            ...
                            '*⚠️ Set Your Wallet Using : *`🗂 Wallet`', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        ...
                        '<b>⛪️Total Payouts: ' + payout + ' ' + currency + '\n\n🎭 Total Users: ' + memb + ' Users\n\n🔍 Developed By <a href="https://t.me/Mrr_Robin">🇮🇳 Robin Piro</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
    ...
    try {
        ...
        if (ctx.message.text == '⛔ Cancel') {
            ...
            ctx.replyWithMarkdown(
                ...
                '*📣 Broadcast Sent To: ' + users.length + ' Users*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
        ...
        if (flag == channel.length) {
            ...
            if (ctx.message.text == '⛔ Cancel') {
                ...
                ctx.replyWithMarkdown(
                    ...
                    '*🗂 Wallet Address Set To: *\n`' + ctx.message.text + '`', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
            ...
            if (flag == channel.length) {
                ...
                if (ctx.message.text == '⛔ Cancel'){
                  ...
                  ctx.replyWithMarkdown(
                        ...
                        '*⛔ Withdrawal Cancelled*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
                    ...
                    ctx.replyWithMarkdown(
                        ...
                        '*⛔ Only Numeric Value Allowed*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
                  ...
                  ctx.replyWithMarkdown(
                        ...
                        '*⛔ Forwards Are Prohibited*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
                    ...
                    ctx.replyWithMarkdown(
                        ...
                        '*⛔ Entered Amount Is Greater Than Your Balance*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
                    ...
                    ctx.replyWithMarkdown(
                        ...
                        '*⚠️ Minimum Withdrawal Is ' + mini_with + ' ' + currency + '*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
                  ...
                  ctx.replyWithMarkdown(
                        ...
                        '*⚠️ Maximum Withdrawal Is 3 ' + currency + '*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
    ...
    if(toWith == 0){
      ...
      return 0;
        ...
        ctx.replyWithMarkdown( 
                        ...
                        "*✅ New Withdrawal Processed ✅\n\n🚀Amount : " + toWith + " " + currency + "\n⛔ Wallet :* `" + wallet + "`\n*💡 Bot: @" + ctx.botInfo.username + "*", {parse_mode:'markdown', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } } 
...
bot.action("cancel",async(ctx)=> {
  ...
  try{
     ...
     ctx.replyWithMarkdown( 
                        ...
                        "*❌ Withdrawal Cancelled *", {parse_mode:'markdown', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } } 
        ...
        if (ctx.message.text == '⛔ Cancel') {
            ...
            if (!data[0]) {
                ...
                ctx.replyWithMarkdown(
                    ...
                    '*⛔ User Is Not Registered In Our Database *', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
                ...
                ctx.reply(
                    ...
                    '<b>🫂 User : <a href="tg://user?id=' + ctx.message.text + '">' + ctx.message.text + '</a>\n⛔ User Id</b> : <code>' + ctx.message.text + '</code>\n\n<b>💰 Balance : ' + bal + '\n🗂 Wallet : </b><code>' + add + '</code>\n<b>👫 Inviter : </b><code>' + invite + '</code>', { parse_mode: 'html', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
    ...
    try {
        ...
        if (ctx.message.text == '⛔ Cancel') {
            ...
            ctx.reply(
                ...
                '<b>💰 Balance Of <a href="tg://user?id=' + user + '">' + user + '</a> Was Increased By ' + amount + '\n\n💰 Final Balance = ' + final + '</b>', { parse_mode: 'html', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
    ...
    try {
        ...
        if (ctx.message.text == '⛔ Cancel') {
            ...
            ctx.reply(
                ...
                '<b>🗂 Channel Added To Bot : ' + ctx.message.text + '</b>', { parse_mode: 'html', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
            ...
            ctx.replyWithMarkdown(
                ...
                '*⛔ Channel User Name Must Start With "@"*', { reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
        ...
        if (ctx.message.text == '⛔ Cancel') {
            ...
            if (contains("" + ctx.message.text + "", chan)) {
                ...
                ctx.reply(
                    ...
                    '<b>🗂 Channel Removed From Bot : ' + ctx.message.text + '</b>', { parse_mode: 'html', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
                ...
                ctx.reply(
                    ...
                    '<b>⛔ Channel Not In Our Database</b>', { parse_mode: 'html', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
    ...
    try {
        ...
        if (ctx.message.text == '⛔ Cancel') {
            ...
            ctx.reply(
                ...
                '<b>🗂 Pay Channel Set To : ' + ctx.message.text + '</b>', { parse_mode: 'html', reply_markup: { keyboard: [['🧩 Invite', '💴 Balance', '🎁 Bonus'], ['📂 Wallet', '📨 Withdraw'], ['📊 Status']], resize_keyboard: true } }
...
bot.action('check', async (ctx) => {
    ...
    try {
        ...
        ctx.editMessageText(
            ...
            "<b>🕹 You Are Referred By: <a href='tg://user?id=" + invite + "'>" + invite + "</a></b>", { parse_mode: 'html' }
